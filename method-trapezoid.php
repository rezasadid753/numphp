...
<body style="direction: rtl;">
    ...
    <div class="page"><a class="button fa back" href="https://rezasadid.com/projects/numericalanalysis/">→ بازگشت به فهرست</a><div>
        <h1 class="fa">انتگرال گیری عددی - روش ذوزنقه ای مرکب</h1>
        <p>
        ...
        <button type="button" onclick="methodtrapezoid()">محاسبه انتگرال تابع <code>(2x+5)*sin(x)+6</code> از 0 تا 5</button>
